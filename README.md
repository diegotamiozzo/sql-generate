...
* **Camada de Inteligência Artificial:** Consome o SDK moderno `Groq` processando estruturas relacionais dinâmicas convertidas em prompts estruturados de alta fidelidade com saídas validadas em `JSON Schema`.
...
* **Credenciais de IA:** Uma chave válida da API do Groq (`GROQ_API_KEY`) obtida em https://console.groq.com/keys.
